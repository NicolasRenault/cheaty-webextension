...
const EYE_OPEN_ICON = '<span class="material-symbols-outlined">visibility</span>' // ? https://fonts.google.com/icons?selected=Material%20Symbols%20Outlined%3Avisibility%3AFILL%400%3Bwght%40300%3BGRAD%40-25%3Bopsz%4024
const EYE_CLOSE_ICON = '<span class="material-symbols-outlined">visibility_off</span>' // ? https://fonts.google.com/icons?selected=Material%20Symbols%20Outlined%3Avisibility_off%3AFILL%400%3Bwght%40300%3BGRAD%40-25%3Bopsz%4024
const TEXT_VISIBLE_ICON = '<span class="material-symbols-outlined">text_fields</span>' // ? https://fonts.google.com/icons?selected=Material%20Symbols%20Outlined%3Atext_fields%3AFILL%400%3Bwght%40300%3BGRAD%40-25%3Bopsz%4024
const TEXT_NOT_VISIBLE_ICON = '<span class="material-symbols-outlined">password</span>' // ? https://fonts.google.com/icons?selected=Material%20Symbols%20Outlined%3Apassword%3AFILL%400%3Bwght%40300%3BGRAD%40-25%3Bopsz%4024
...
function displayComponents(components) {
    ...
    if (components.length !== 0) {
        ...
        components.forEach((el) => {
            ...
            if (actions[0] !== "") {
                button_container.appendChild(createActionButton(componentId, "hide", actions[0].split(":")[1]));
            }
            
            if (actions[1] !== "") {
                button_container.appendChild(createActionButton(componentId, "password", actions[1].split(":")[1]));
            }
